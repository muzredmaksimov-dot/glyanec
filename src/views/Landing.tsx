            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 max-w-lg text-sm leading-relaxed text-ink-800/70">
                  Установите на телефон как приложение: иконка на рабочем столе, быстрый запуск и push-уведомления о записях.
                  На Android — Chrome, меню ⋮ → «Установить приложение» (пуш работают именно у установленной PWA).
